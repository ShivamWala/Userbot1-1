...
WEATHER_DEFCITY = os.environ.get("WEATHER_DEFCITY", "Delhi")
...
# Youtube API key
YOUTUBE_API_KEY = os.environ.get("YOUTUBE_API_KEY", "AIzaSyCI26lFRwzf-SW0EuTM23SAPT2X7Z5IGWM")

# Default .alive name
ALIVE_NAME = os.environ.get("ALIVE_NAME", "Aniket")
